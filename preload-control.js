...
contextBridge.exposeInMainWorld('app', {
  ...
  updateOldInstallers: () => ipcRenderer.invoke('update:oldInstallers'),
  updateTidy: () => ipcRenderer.invoke('update:tidy'),
  onUpdate: on('update:state'),
  worthGet: () => ipcRenderer.invoke('worth:get'),
  budgetGet: () => ipcRenderer.invoke('budget:get'),
  budgetSet: (change) => ipcRenderer.invoke('budget:set', change),
  budgetPlan: (change) => ipcRenderer.invoke('budget:plan', change),
  budgetResetPurchases: () => ipcRenderer.invoke('budget:resetPurchases'),
  budgetWhatIf: (price) => ipcRenderer.invoke('budget:whatIf', price),
  budgetHudSetting: (on) => ipcRenderer.invoke('ui:budgetHud', on),
  onBudgetHud: on('budget:hud'),
  spotMapSetting: (on) => ipcRenderer.invoke('ui:spotMap', on),
  ...
  onSellBlocked: on('harvest:sellBlocked'),
  onSellGuard: on('harvest:sellGuard'),
  ...
  roomsShareSetting: (on) => ipcRenderer.invoke('rooms:shareSetting', on),
  roomsShareStatus: () => ipcRenderer.invoke('rooms:shareStatus'),
  onRoomShare: on('rooms:share'),
  ...
  onBudgetCrossed: on('budget:crossed'),
